    ...
    <div className="min-h-[85vh] flex items-center justify-center px-6 py-12 bg-white relative">
      ...
      <div className="w-full max-w-md p-8 rounded-2xl liquid-glass-card shadow-2xl space-y-6 relative z-10">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight md:tracking-[-0.02em]">Join PuffiFlow 4K</h1>
          ...
          <div>
            ...
            {emailAlreadyExists && (
              <p className="text-xs text-amber-700 font-medium mt-1.5 flex items-center justify-between">
                ...
                <Link href="/login" className="underline font-bold hover:text-[#71C9CE]">Log in instead?</Link>
              </p>
            )}
          </div>
        ...
        <p className="text-center text-xs font-medium text-slate-600">
          ...
          <Link href="/login" className="text-[#71C9CE] font-bold hover:underline">
            Log in
          </Link>
        </p>
      </div>
